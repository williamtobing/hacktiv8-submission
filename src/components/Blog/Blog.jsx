            ...
            <tr>
              ...
              <td className="dark:text-white">
                ...
                <span className="text-gray-600 dark:text-gray-400">
                  ...
                  it painless to create interactive UIs. Design simple views for
            ...
            <tr>
              ...
              <td className="dark:text-white">
                ...
                <span className="text-gray-600 dark:text-gray-400">
                  ...
                  without much of the complexity that comes with modern SPAs. It
                  does this by leveraging existing server-side frameworks...{" "}
                  <span className="hover:underline">
                    <a
            ...
            <tr>
              ...
              <td className="dark:text-white">
                ...
                <span className="text-gray-600 dark:text-gray-400">
                  ...
                  the implementation for your application's login, registration,
                  email verification, two-factor authentication, session
                  management, API via Laravel Sanctum, and optional team
                  management features...{" "}
                  <span className="hover:underline">
                    <a
